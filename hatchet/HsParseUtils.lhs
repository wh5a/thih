-----------------------------------------------------------------------------
-- $Id: HsParseUtils.lhs,v 1.4 2001/12/17 03:38:54 bjpop Exp $
--
...
checkExpr e = case e of
	...
	HsLambda _srcLoc ps e		  -> check1Expr e (HsLambda _srcLoc ps)         -- srcLoc added by Bernie
...
checkStmt (HsGenerator sloc p e) = check1Expr e (HsGenerator sloc p)
...
checkPrec :: String -> P String
checkPrec cs@[c] | isDigit c = returnP cs
